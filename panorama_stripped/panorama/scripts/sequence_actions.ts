...
class DispatchEventAction<E extends keyof DotaEventHandlers> extends RunFunctionAction {
    constructor(
        public eventName: E,
        ...argsArray: EventParams<DotaEventHandlers[E]>
    ) {
...
class AnimateDialogVariableIntAction implements ISequenceAction {
    ...
    endTimestamp = 0;
    constructor(
        public panel: Panel_t,
        public dialogVariable: string,
...
class AnimateProgressBarAction implements ISequenceAction {
    ...
    endTimestamp = 0;
    constructor(
        public progressBar: ProgressBar_t,
        public startValue: number,
        public endValue: number,
        public seconds: number,
    ) {}
...
class AnimateProgressBarWithMiddleAction implements ISequenceAction {
    ...
    endTimestamp = 0;
    constructor(
        public progressBar: ProgressBarWithMiddle_t,
        public startValue: number,
        public endValue: number,
        public seconds: number,
    ) {}
...
class GuardedAction implements ISequenceAction {
    ...
    constructor(
        public action: ISequenceAction,
        public guard: null | (() => boolean),
    ) {}
