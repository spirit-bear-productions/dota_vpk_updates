...
var FlameReveal = function (panel_id: string): void {
    ...
    while (currentFrame < LOOP_START) {
        flameRevealSeq.actions.push(
            new RemoveClassAction(node, "Frame" + (currentFrame - 1).toString().padStart(3, "0")),
        );
