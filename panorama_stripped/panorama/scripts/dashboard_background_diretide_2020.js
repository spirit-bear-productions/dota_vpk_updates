        ...
        seq.actions.push(
            new RunFunctionAction(function () {
                $.DispatchEvent(
                    ...
                    "Diretide2020EventDetails",
                    "file://{resources}/layout/events/diretide_2020_event_details.xml",
                );
            }),
        );
    }
...
var RunIdleAnimation = function () {
    ...
    seq.actions.push(new FireEntityInputAction(scenePanel, "roshan_light_03", "Intensity", "0"));
    seq.actions.push(
        new FireEntityInputAction(scenePanel, "debut_camera", "SetAnimation", "diretide_camera_anim_lastframe"),
    );
...
var RunCandyAnimation = function () {
    if (g_bIsPlayingCandyAnimation) return;

    g_nCandyAnimationClicked++;
    if (g_nCandyAnimationClicked < 3) return;
    ...
    seq.actions.push(new WaitForClassAction(scenePanel, "SceneLoaded"));
    seq.actions.push(
        new FireEntityInputAction(scenePanel, "roshan", "SetAnimation", "tot_roshan_askforcandy_frontpage"),
    );
    seq.actions.push(
        new FireEntityInputAction(
            scenePanel,
            "debut_camera",
            "SetAnimation",
            "diretide_frontpage_camera_askcandy_anim",
        ),
    );
    ...
    seq.actions.push(
        new RunFunctionAction(function () {
            g_bIsPlayingCandyAnimation = false;
        }),
    );
...
var GetActivePageType = function () {
    ...
    for (var i = 0; i < pageManager.GetChildCount(); ++i) {
        ...
        if (page.BHasClass("PageVisible")) return page.paneltype;
    }
...
var UpdateAnimation = function () {
    ...
    if (!$("#BackgroundScene").BHasClass("SceneLoaded")) return;
