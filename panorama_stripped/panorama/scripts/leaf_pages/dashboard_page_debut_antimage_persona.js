...
var RunPageAnimation = function () {
    ...
    g_seq.actions.push(
        new RunFunctionAction(function () {
            $("#AMModelBackground").FireEntityInput("antimage_persona", "SetAnimation", "antimage_persona_debut_spawn");
        }),
    );
    ...
    g_seq.actions.push(new WaitAction(4.0));
    ...
    g_seq.actions.push(
        new RunFunctionAction(function () {
            $("#AMModelBackground").FireEntityInput(
                "antimage_persona",
                "SetAnimation",
                "antimage_persona_debut_anim_5s_loop",
            );
        }),
    );
    ...
    g_seq.actions.push(
        new RunFunctionAction(function () {
            $("#AMModelBackground").FireEntityInput("antimage_persona", "SetAnimation", "meditation_04");
        }),
    );
    ...
    g_seq.actions.push(
        new RunFunctionAction(function () {
            $("#AMModelBackground").FireEntityInput(
                "antimage_persona",
                "SetAnimation",
                "antimage_persona_debut_anim_5s",
            );
        }),
    );
    g_seq.actions.push(new WaitAction(5.0));
    g_seq.actions.push(
        new RunFunctionAction(function () {
            $("#AMModelBackground").FireEntityInput("antimage_persona", "SetAnimation", "meditation_03");
        }),
    );
    ...
    g_seq.actions.push(
        new RunFunctionAction(function () {
            $("#AMModelBackground").FireEntityInput("antimage_persona", "SetAnimation", "meditation_02");
        }),
    );
    ...
    g_seq.actions.push(
        new RunFunctionAction(function () {
            $("#AMModelBackground").FireEntityInput("antimage_persona", "SetAnimation", "meditation_05");
        }),
    );
    ...
    g_seq.actions.push(
        new RunFunctionAction(function () {
            $("#AMModelBackground").FireEntityInput("antimage_persona", "SetAnimation", "meditation_013");
        }),
    );
