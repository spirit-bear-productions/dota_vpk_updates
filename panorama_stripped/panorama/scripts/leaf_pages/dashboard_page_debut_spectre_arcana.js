...
var RunPageAnimation = function () {
    ...
    g_seq.actions.push(
        new LerpDepthOfFieldAction($("#ModelBackground"), "herocamera", 275, 300, 310, 325, 150, 275, 325, 800, 4.0),
    );
    g_seq.actions.push(
        new LerpDepthOfFieldAction($("#ModelBackgroundAlt"), "herocamera", 275, 300, 310, 325, 150, 275, 325, 800, 4.0),
    );

    g_seq.actions.push(new WaitAction(4.2));
