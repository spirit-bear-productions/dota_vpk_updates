...
var RunPageAnimation = function () {
    ...
    seq.actions.push(
        new RunFunctionAction(function () {
            $("#ModelBackground").FireEntityInput("qop_arcana_alt", "Disable", "0");
        }),
    );
    seq.actions.push(
        new RunFunctionAction(function () {
            $.DispatchEvent("PlaySoundEffect", "qop_arcana_takeover_stinger");
        }),
    );
...
function alternateStyle() {
    ...
    $.Schedule(1.0, function () {
        $("#ModelBackground").FireEntityInput("qop_arcana_alt", "SetActivity", "ACT_DOTA_LOADOUT");
    });
}
