...
function BShallowEqual<T>(
    pObj1: T | null,
    pObj2: T | null,
    ...ignoreKeys: Array<string & keyof NonNullable<T>>
): boolean {
...
function BuildUnrankedGameModePanel(
    pParent: Panel_t,
    nMode: DOTA_GameMode,
    pFeaturedGamemodeDef?: CDOTAFeaturedGamemodeDefinition,
): Panel_t | null {
    const mode = k_GameModesMap[nMode];
    if (!mode) return null;
