...
function Sequence_ShowAdvanced() {
    ...
    var advancedMessageID = $.GetContextPanel().BHasClass("HasChampionTeamMessage")
        ? "#TeamChampionMessage"
        : "#TeamAdvancedMessage";
...
(function () {
    $.RegisterForUnhandledEvent(
        "DOTAWeekendTourneyMatchOutcomeSequenceBegin",
        EventDOTAWeekendTourneyMatchOutcomeSequenceBegin,
    );
})();
