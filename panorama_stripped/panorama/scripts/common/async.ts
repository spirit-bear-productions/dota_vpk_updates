...
namespace Async {
    ...
    export function UnhandledEvent<E extends keyof DotaEventHandlers>(
        sEvent: E,
    ): Promise<EventParams<DotaEventHandlers[E]>>;

    export function UnhandledEvent<E extends keyof DotaEventHandlers>(
        sEvent: E,
        ...match: EventParams<DotaEventHandlers[E]>
    ): Promise<EventParams<DotaEventHandlers[E]>>;

    export function UnhandledEvent<E extends keyof DotaEventHandlers>(
        sEvent: E,
        predicate: (...args: EventParams<DotaEventHandlers[E]>) => boolean,
    ): Promise<EventParams<DotaEventHandlers[E]>>;
    ...
    export function UnhandledEvent<E extends keyof DotaEventHandlers>(
        ...
        return new Promise((resolve) => {
            const nHandlerId = $.RegisterForUnhandledEvent(sEvent, function (
                ...args: EventParams<DotaEventHandlers[E]>
            ) {
    ...
    export type SequenceFn_t = (
        abortSignal: Async.AbortSignal_t,
    ) => Generator<unknown, void, unknown> | AsyncGenerator<unknown, void, unknown>;
