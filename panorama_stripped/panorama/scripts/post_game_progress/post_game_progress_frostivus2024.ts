...
function AnimateFrostivus2024Quest(
    questPanel: Panel_t,
    actions: ISequenceAction[],
    quest_data: Frostivus2024QuestProgress_t,
) {}

function AnimateFrostivus2024QuestProgress(
    panel: Panel_t,
    actions: ISequenceAction[],
    inventory_data: Frostivus2024InventoryComponent_t[],
) {
...
class AnimateFrostivus2024ScreenAction extends RunSequentialActions {
    ...
    start() {
        ...
        let bAnyProgress: boolean = AnimateFrostivus2024QuestProgress(
            panel,
            this.actions,
            this.data.frostivus2024_progress.inventory,
        );
