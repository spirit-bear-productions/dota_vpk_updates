class AnimateHeroBadgeXPIncreaseAction extends RunSequentialActions {
    ...
    start() {
        ...
        par.actions.push(
            new AnimateDialogVariableIntAction(
                row,
                "xp_value",
                this.xpValueStart,
                this.xpValueStart + this.xpAmount,
                duration,
            ),
        );
        par.actions.push(
            new AnimateDialogVariableIntAction(
                ...
                "xp_value",
                this.xpEarnedStart,
                this.xpEarnedStart + this.xpAmount,
                duration,
            ),
        );
        par.actions.push(
            new AnimateDialogVariableIntAction(this.panel, "current_level_xp", minLevelXP, maxLevelXP, duration),
        );
    ...
    start() {
        ...
        par.actions.push(
            new AnimateDialogVariableIntAction(
                ...
                "shard_value",
                this.totalStart,
                this.totalStart + this.shardAmount,
                duration,
            ),
        );
        par.actions.push(
            new AnimateDialogVariableIntAction(
                this.panel,
                "current_shards",
                this.currentShardsStart,
                this.currentShardsStart + this.shardAmount,
                duration,
            ),
        );
        par.actions.push(new PlaySoundForDurationAction("XP.Count", duration));
    ...
    start() {
        ...
        par.actions.push(
            new AnimateDialogVariableIntAction(
                ...
                this.totalStartPoints + this.increaseAmount,
                duration,
            ),
        );
        par.actions.push(new PlaySoundForDurationAction("XP.Count", duration));
    ...
    start() {
            ...
            for (var i = 0; i < heroBadgeProgress.length; ++i) {
                ...
                while (xpRemaining > 0) {
                    ...
                    if (xpToAnimate > 0) {
                        this.actions.push(
                            new SkippableAction(
                                new AnimateHeroBadgeXPIncreaseAction(
                                    heroLevelSection,
                                    heroBadgeProgress[i],
                                    xpToAnimate,
                                    xpEarnedOnRow,
                    ...
                    if (xpToNextLevel == 0 && heroLevel < k_unMaxHeroRewardLevel) {
                        ...
                        (function (me, heroLevel) {
                            ...
                            if (levelUpData) {
                                ...
                                me.actions.push(
                                    new ActionWithTimeout(new WaitForClassAction(levelUpScene, "SceneLoaded"), 3.0),
                                );
                                ...
                                me.actions.push(
                                    new RunFunctionAction(function () {
                                        ...
                                        $.DispatchEvent(
                                            ...
                                            levelUpScene,
                                            "light_rank_" + levelUpData.tier_number,
                                            "TurnOn",
                                            "1",
                                        );
                                        $.DispatchEvent(
                                            "DOTASceneFireEntityInput",
                                            levelUpScene,
                                            "particle_rank_" + levelUpData.tier_number,
                                            "start",
                                            "1",
                                        );
                                    }),
                                ...
                                for (var j = 0; j < levelUpData.rewards.length; ++j) {
                                    me.actions.push(
                                        new SkippableAction(
                                            new AnimateHeroBadgeLevelRewardAction(levelUpData.rewards[j], rewardsPanel),
                                        ),
                                    );
                                }
                                ...
                                me.actions.push(
                                    new WaitForEventAction(
                                        panel.FindChildInLayoutFile("RewardsFinishedButton"),
                                        "Activated",
                                    ),
                                );
                            ...
                            me.actions.push(
                                new RunFunctionAction(function () {
                                    ...
                                    panel.SwitchClass(
                                        "tier",
                                        $.GetContextPanel().GetHeroBadgeTierClassForHeroLevel(heroLevel),
                                    );
                                }),
                            );
                        })(this, heroLevel);
                        ...
                        (function (me, xpLevelInternal, xpLevelNextInternal) {
                            me.actions.push(
                                new RunFunctionAction(function () {
                                    ...
                                    panel.FindChildInLayoutFile("MatchRewardsHeroLevelProgressBar").max =
                                        xpLevelNextInternal;
                                    panel.FindChildInLayoutFile("MatchRewardsHeroLevelProgressBar").value =
                                        xpLevelInternal;
                                }),
                            );
        ...
        if (dotaPlusProgress !== undefined) {
            ...
            if (dotaPlusProgress.guild_contracts_shard_reward > 0) {
                this.actions.push(
                    new AnimateShardRewardAction(
                        panel,
                        "#DOTA_PlusPostGame_GuildContracts",
                        dotaPlusProgress.guild_contracts_shard_reward,
                        nTotalEarned,
                        nCurrentShards,
                    ),
                );
            ...
            if (dotaPlusProgress.victory_prediction_shard_reward > 0) {
                this.actions.push(
                    new AnimateShardRewardAction(
                        panel,
                        "#DOTA_PlusPostGame_VictoryPrediction",
                        dotaPlusProgress.victory_prediction_shard_reward,
                        nTotalEarned,
                        nCurrentShards,
                    ),
                );
            ...
            if (dotaPlusProgress.cavern_crawl !== undefined) {
                this.actions.push(
                    new AnimateShardRewardAction(
                        ...
                        dotaPlusProgress.cavern_crawl.shard_amount,
                        nTotalEarned,
                        nCurrentShards,
                    ),
                );
            ...
            if (dotaPlusProgress.role_call_shard_reward > 0) {
                this.actions.push(
                    new AnimateShardRewardAction(
                        panel,
                        "#DOTA_PlusPostGame_RoleCallProgress",
                        dotaPlusProgress.role_call_shard_reward,
                        nTotalEarned,
                        nCurrentShards,
                    ),
                );
            ...
            if (dotaPlusProgress.max_level_hero_challenge_shard_reward > 0) {
                this.actions.push(
                    new AnimateShardRewardAction(
                        ...
                        dotaPlusProgress.max_level_hero_challenge_shard_reward,
                        nTotalEarned,
                        nCurrentShards,
                    ),
                );
            ...
            if (dotaPlusProgress.featured_gamemode_progress != null) {
                var nGainedShards =
                    dotaPlusProgress.featured_gamemode_progress.end_value -
                    dotaPlusProgress.featured_gamemode_progress.start_value;
                if (nGainedShards > 0) {
                    this.actions.push(
                        new AnimateShardRewardAction(
                            panel,
                            "#DOTA_PlusPostGame_FeaturedGameMode",
                            nGainedShards,
                            nTotalEarned,
                            nCurrentShards,
                        ),
        ...
        if (guildProgress) {
            ...
            if (guildProgress.guild_challenge != null) {
                ...
                challengeProgressBar.uppervalue =
                    guildChallenge.challenge_start_value + guildChallenge.challenge_progress;
            ...
            if (guildProgress.match_guild_points != null) {
                if (guildProgress.match_guild_points.match_completed_guild_points > 0) {
                    ...
                    if (guildProgress.match_guild_points.party_guild_member_count <= 1) {
                        ...
                        guildSection.SetDialogVariableInt(
                            "party_member_count",
                    ...
                    this.actions.push(
                        new AnimateGuildPointsRewardAction(
                            guildSection,
                            pointsLabel,
                            nGuildPointsEarned,
                            guildProgress.match_guild_points.match_completed_guild_points,
                        ),
                    );
                ...
                if (guildProgress.match_guild_points.win_guild_points > 0) {
                    this.actions.push(
                        new AnimateGuildPointsRewardAction(
                            guildSection,
                            $.Localize("#DOTA_MatchRewards_WinGuildPoints"),
                            nGuildPointsEarned,
                            guildProgress.match_guild_points.win_guild_points,
                        ),
                    );
            ...
            if (nContractGuildPoints > 0) {
                this.actions.push(
                    new AnimateGuildPointsRewardAction(
                        guildSection,
                        $.Localize("#DOTA_MatchRewards_ContractsCompleted"),
                        nGuildPointsEarned,
                        nContractGuildPoints,
                    ),
                );
        ...
        this.actions.push(
            new RunFunctionAction(function () {
                $.DispatchEvent("DOTASetDashboardBackgroundVisible", true);
            }),
        );
