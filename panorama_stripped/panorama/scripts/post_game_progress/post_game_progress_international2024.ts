...
class AnimateInternational2024ScreenAction extends RunSequentialActions {
    ...
    start() {
        ...
        let weeklyProgressBar: ProgressBarWithMiddle_t = panel.FindChildInLayoutFile(
            "WeeklyProgressBar",
        ) as ProgressBarWithMiddle_t;
        let compendiumLevelProgressBar: ProgressBarWithMiddle_t = panel.FindChildInLayoutFile(
            "CompendiumLevelProgressBar",
        ) as ProgressBarWithMiddle_t;
        ...
        this.actions.push(
            new AddScreenLinkAction(panel, "International2024Progress", "#DOTA_EventName_International2024"),
        );
        ...
        while (nTotalPointsToAnimate > 0) {
            ...
            par.actions.push(
                new AnimateDialogVariableIntAction(
                    panel,
                    "weekly_points_current",
                    nWeeklyProgressPoints,
