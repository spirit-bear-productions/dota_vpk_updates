...
type ShmupAnimationFunction_t = (
    panel: DOTABPCrownfallEncounterShmupPopup_t,
...
function _RunUIAnimation(animFunc: ShmupAnimationFunction_t): void {
    ...
    Async.RunSequence(function* (abortSignal) {
        yield* animFunc(panel, abortSignal);
    }, gUIEventAsyncAbort.signal);
}
