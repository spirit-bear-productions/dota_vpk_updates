...
var LookTriggerActivated = function () {
    const page = $.GetContextPanel<DOTABackgroundCCSummer2023_t>();
    if (page.IsLookAtEnabled()) return;
...
var RunPageAnimation = function () {
    ...
    mainSeq.actions.push(
        new RunFunctionAction(function () {
            ...
            mainPanel.FireEntityInput(
                "hero_camera_driver",
                "SetAnimation",
                "camera_dashboard_loadout_treasure_spin_subtle_static",
            );
            ...
            $.Schedule(2, function () {
                mainPanel.FireEntityInput(
                    "hero_camera_driver",
                    "SetAnimation",
                    "camera_dashboard_loadout_treasure_spin_subtle",
                );
            });
