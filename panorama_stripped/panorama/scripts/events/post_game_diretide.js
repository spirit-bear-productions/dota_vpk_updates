...
function CreatePopuplateHeroScenesAction(data) {
    ...
    data.diretide_rewards_progress.match_players.forEach(function (playerData, idx) {
        ...
        vSequence.actions.push(
            new WaitForConditionAction(function () {
...
function CreateAwardAction(awardData, rootPanel) {
    ...
    vKickerPanels.forEach(function (kicker) {
        ...
        vParallelAction.actions.push(
            new AnimateCandyCountAction(
                kicker.GetParent(),
                "event_points",
                kicker.nStartPointsValue,
                kicker.nEndPointsValue,
                0.4,
            ),
        );
    });
...
function CreateItemRewardAction(itemData, rootPanel) {
    ...
    rootPanel.heroPanels.forEach(function (heroPanel) {
        if (itemData.item_player_slot !== heroPanel.playerSlot) return;
...
$.GetContextPanel().CreatePostgameAction = function (data) {
    ...
    data.diretide_rewards_progress.items.forEach(function (itemData) {
