...
function PlayQuarteroDialog() {
    ...
    seq.actions.push(
        new Quartero_RunSequentialActionsUntilClickThrough(
            "q03_intro_qart_01",
            "Description_q02_intro_01",
            "ShowQuarteroArt_01",
        ),
    );
    //seq.actions.push( new Quartero_RunSequentialActionsUntilClickThrough( 'q03_intro_qart_02', 'Description_q02_intro_02', '' ) );
    seq.actions.push(
        new Quartero_RunSequentialActionsUntilClickThrough("q03_intro_qart_03", "Description_q02_intro_03", ""),
    );
    seq.actions.push(
        new Quartero_RunSequentialActionsUntilClickThrough("q03_intro_qart_04", "Description_q02_intro_04", ""),
    );
    seq.actions.push(
        new Quartero_RunSequentialActionsUntilClickThrough("q03_intro_qart_05", "Description_q02_intro_05", ""),
    );
    seq.actions.push(
        new Quartero_RunSequentialActionsUntilClickThrough("q03_intro_qart_06", "Description_q02_intro_06", ""),
    );
    seq.actions.push(
        new Quartero_RunSequentialActionsUntilClickThrough("q03_intro_qart_07", "Description_q02_intro_07", ""),
    );
    seq.actions.push(
        new Quartero_RunSequentialActionsUntilClickThrough("q03_intro_qart_08", "Description_q02_intro_08", ""),
    );
    seq.actions.push(
        new Quartero_RunSequentialActionsUntilClickThrough("q03_intro_qart_09", "Description_q02_intro_09", ""),
    );
    seq.actions.push(
        new Quartero_RunSequentialActionsUntilClickThrough("q03_intro_qart_10", "Description_q02_intro_10", ""),
    );
