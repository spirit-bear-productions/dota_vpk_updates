...
var UpdateActivateLevelsNextButton = function () {
    ...
    $("#ApplyLevelsNextButton").text = bApplyLevels
        ? $.Localize("#DOTA_ActivateLevels")
        : $.Localize("#DOTA_SaveForLater");
};
...
$.Schedule(0.0, function () {
    $.RegisterEventHandler("DOTAPurchaseEventLevelsTableQuantityChanged", $("#LevelsTable"), function (table) {
