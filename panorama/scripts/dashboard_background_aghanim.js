...
var IsModelUnlocked = function (nIndex) {
    ...
    if (k_modelInfos[nIndex].unlockAction == undefined) return true;
...
$.Schedule(0.0, function () {
    ...
    for (var i = 0; i < k_modelInfos.length; ++i) {
        ...
        unlockIcon.SetPanelEvent(
            "onactivate",
            (function (nIndex) {
                return function () {
                    ActivateModel(nIndex);
                };
            })(i),
        );
    }
    ...
    if (bPlaySound) {
        ...
        if (IsModelUnlocked(g_nCurrentModelIndex)) {
            ...
            $.Schedule(
                ...
                (function (nCookie) {
                    return function () {
                        if (nCookie != g_nSoundCookie) return;
                        ...
                        seq.actions.push(
                            new RunFunctionAction(function () {
                                g_bPlayingVoiceoverSound = false;
                            }),
                        );
                        RunSingleAction(seq);
                    };
...
var ActivateModel = function (nIndex) {
    ...
    if (speechChoice) {
        ...
        $.Schedule(0.1, function () {
            ModelContainer.AddClass("HelpMe");
        });
...
var MaybeUpdateInitalModel = function () {
    if (g_nCurrentModelIndex != -1) return;
