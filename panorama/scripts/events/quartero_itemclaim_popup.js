...
const gSequences = [gLookAtWatch, gLookAtWatch, gTentHands];
...
const gShardHoverSequences = [gShardHoverSequence];
...
function StartActorPictureAnimation() {
    ...
    Async.RunSequence(function* (signal) {
        yield* gQuatero.RunCoroutine(signal);
    }, gAsyncAbort.signal);
}
