...
var RunPageAnimation = function () {
    ...
    seq.actions.push(
        new RunFunctionAction(function () {
            $("#ModelBackground").FireEntityInput("dawnbreaker_hammer_ambient_fx", "stop", "0");
        }),
    );
    ...
    seq.actions.push(
        new RunFunctionAction(function () {
            $("#ModelBackground").FireEntityInput(
                "dawnbreaker_debut_fx_model",
                "SetAnimation",
                "dawnbreaker_debut_layout",
            );
        }),
    );
    if (debug_animation) {
        seq.actions.push(
            new RunFunctionAction(function () {
                $("#ModelBackground").FireEntityInput("valora", "SetAnimation", "battlemaiden_debut_layout");
            }),
        );
        ...
        seq.actions.push(
            new RunFunctionAction(function () {
                $("#ModelBackground").FireEntityInput("valora", "Disable", "0");
            }),
        );
        seq.actions.push(new WaitAction(4.0));
        seq.actions.push(
            new RunFunctionAction(function () {
                $("#ModelBackground").FireEntityInput("valora", "Enable", "0");
            }),
        );
        seq.actions.push(
            new RunFunctionAction(function () {
                $("#ModelBackground").FireEntityInput("valora", "SetAnimation", "battlemaiden_debut_truncated");
            }),
        );
    }
    ...
    seq.actions.push(
        new RunFunctionAction(function () {
            $("#ModelBackground").FireEntityInput("melee_creep_a", "SetAnimation", "battlemaiden_debut_creep_a");
        }),
    );
    seq.actions.push(
        new RunFunctionAction(function () {
            $("#ModelBackground").FireEntityInput("melee_creep_b", "SetAnimation", "battlemaiden_debut_creep_b");
        }),
    );
    seq.actions.push(
        new RunFunctionAction(function () {
            $("#ModelBackground").FireEntityInput("melee_creep_c", "SetAnimation", "battlemaiden_debut_creep_c");
        }),
    );
    seq.actions.push(
        new RunFunctionAction(function () {
            $("#ModelBackground").FireEntityInput("melee_creep_d", "SetAnimation", "battlemaiden_debut_creep_d");
        }),
    );
    ...
    seq.actions.push(
        new RunFunctionAction(function () {
            $("#ModelBackground").FireEntityInput("dawnbreaker_hammer_ambient_fx", "start", "0");
        }),
    );
    ...
    seq.actions.push(
        new RunFunctionAction(function () {
            $("#ModelBackground").FireEntityInput("valora", "SetAnimation", "battlemaiden_debut_idle");
        }),
    );
