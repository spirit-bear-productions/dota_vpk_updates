...
var RunPageAnimation = function () {
    ...
    seq.actions.push(
        new RunFunctionAction(function () {
            $("#Model").FireEntityInput("hoodwink", "SetAnimation", "hoodwink_debut_spawn");
        }),
    );
    seq.actions.push(
        new RunFunctionAction(function () {
            $("#Model").FireEntityInput("creep1", "SetAnimation", "hoodwink_debut_crp1");
        }),
    );
    seq.actions.push(
        new RunFunctionAction(function () {
            $("#Model").FireEntityInput("creep2", "SetAnimation", "hoodwink_debut_crp2");
        }),
    );
    ...
    if (ANIMATE_STARTING_RACK_FOCUS) {
        ...
        seq.actions.push(
            new RunFunctionAction(function () {
                $("#Model").FireEntityInput("intro_camera", "SetDOFFarCrisp", 500);
            }),
        );
        seq.actions.push(
            new RunFunctionAction(function () {
    ...
    seq.actions.push(
        new RunFunctionAction(function () {
            $("#Model").FireEntityInput("hoodwink", "SetAnimation", "hoodwink_debut_idle");
        }),
    );
