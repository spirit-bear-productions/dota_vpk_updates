...
$.Schedule(0.0, function () {
    $.RegisterEventHandler("DOTAScenePanelSceneLoaded", $("#ModelBackground"), function () {
        $.DispatchEvent("PlaySoundEffect", "rubick_arc_takeover_stinger");
    });
});

var SetShowingProgress = function (bShowProgress) {
    if (g_bIsTransitioningShowingProgress) return;

    if (g_bIsShowingProgress == bShowProgress) return;
    ...
    if (bShowProgress) {
        ...
        $("#ModelBackground").FireEntityInput(
            "debut_camera",
            "SetAnimation",
            "debut_camera_rubick_arcana_transition_left_tk3",
        );
        $("#ModelBackground").FireEntityInput(
            "arcana_prop",
            "SetAnimation",
            "rbck_arc_debut_prop_anim_transition_left_tk3",
        );
        ...
        $.Schedule(7.1, function () {
            if (!g_bIsOnRight && !g_bIsTransitioningShowingProgress) {
                $("#ModelBackground").FireEntityInput(
                    "debut_camera",
                    "SetAnimation",
                    "debut_camera_rubick_arcana_idle_left_tk3",
                );
                $("#ModelBackground").FireEntityInput(
                    "arcana_prop",
                    "SetAnimation",
                    "rbck_arc_debut_prop_anim_idle_left_tk3",
                );
                $("#ModelBackground").FireEntityInput("hero", "SetActivityModifier", "debut_left");
        ...
        $("#ModelBackground").FireEntityInput(
            "debut_camera",
            "SetAnimation",
            "debut_camera_rubick_arcana_transition_right_tk3",
        );
        $("#ModelBackground").FireEntityInput(
            "arcana_prop",
            "SetAnimation",
            "rbck_arc_debut_prop_anim_transition_right_tk3",
        );
        ...
        $.Schedule(10.36, function () {
            if (g_bIsOnRight && !g_bIsTransitioningShowingProgress) {
                $("#ModelBackground").FireEntityInput(
                    "debut_camera",
                    "SetAnimation",
                    "debut_camera_rubick_arcana_idle_right_tk3",
                );
                $("#ModelBackground").FireEntityInput(
                    "arcana_prop",
                    "SetAnimation",
                    "rbck_arc_debut_prop_anim_idle_right_tk3",
                );
                $("#ModelBackground").FireEntityInput("hero", "SetActivityModifier", "debut_right");
                $("#ModelBackground").FireEntityInput("hero", "SetActivity", "ACT_DOTA_LOADOUT");
            }
