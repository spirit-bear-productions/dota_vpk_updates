...
function OnHoverButton(buttonName, abilityPanelName, IsUltimate) {
    ...
    var mainContainerPanel = $("#MainContainer");
    if (
        abilityDraftPanel.BHasClass("AbilityDraftPreRound") ||
        !abilityDraftPanel.BHasClass("LocalPlayerIsDrafting") ||
        (IsUltimate && mainContainerPanel.BHasClass("UltimateChosen"))
    ) {
        return;
    }
...
function OnHoverButtonHero(buttonName, heroPanelName) {
    ...
    if (
        abilityDraftPanel.BHasClass("AbilityDraftPreRound") ||
        !abilityDraftPanel.BHasClass("LocalPlayerIsDrafting") ||
        mainContainerPanel.BHasClass("HeroChosen")
    ) {
        return;
    }
...
function OnActivateUltimate(blockName, abilityPanelName, abilityIndex) {
    ...
    if (
        !abilityDraftPanel.BHasClass("LocalPlayerIsDrafting") ||
        abilityDraftPanel.BHasClass("CurrentPlayerHasChosen") ||
        scenePanel.BHasClass("UltimateChosen")
    ) {
        return;
    }
...
function OnActivateHero(blockName, heroPanelName, heroIndex) {
    ...
    if (
        !abilityDraftPanel.BHasClass("LocalPlayerIsDrafting") ||
        abilityDraftPanel.BHasClass("CurrentPlayerHasChosen") ||
        scenePanel.BHasClass("HeroChosen")
    ) {
        return;
    }
