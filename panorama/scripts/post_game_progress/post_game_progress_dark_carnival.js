...
function AnimateDarkCarnivalFortuneTellerProgress(panel, actions, data) {
    ...
    let progressToken =
        data.daily_coins_previously_earned !== data.daily_coins_previously_earned
            ? "#DOTA_Dark_Carnival_PostGame_FortuneTellerProgress"
            : "#DOTA_Dark_Carnival_PostGame_FortuneTellerMaxProgress";
    progressLabel?.SetDialogVariableInt(
        "earned_coins",
        data.daily_coins_previously_earned + Number(data.earned_daily_coin),
    );
    ...
    start() {
        ...
        actions.push(
            new AddScreenLinkAction(
                panel,
                "DarkCarnivalProgress",
                "#DOTA_PlusPostGame_DarkCarnivalProgress",
                function () {
