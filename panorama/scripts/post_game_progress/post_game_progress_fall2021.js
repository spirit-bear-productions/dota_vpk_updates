...
class AnimateFall2021EventGameAction extends RunSequentialActions {
    ...
    start() {
        ...
        parBattlePoints.actions.push(
            new AnimateDialogVariableIntAction(
                this.sectionPanel,
                "event_game_points_earned",
                0,
                this.eventGameData.bp_amount,
                duration,
            ),
        );
        ...
        parFragments.actions.push(
            new AnimateDialogVariableIntAction(
                this.sectionPanel,
                "event_game_fragments_earned",
                0,
                this.eventGameData.fragment_amount,
                duration,
            ),
        );
...
class AnimateFall2021ScreenAction extends RunSequentialActions {
    ...
    start() {
        ...
        levelShield.SetEventPoints(
            ...
            this.data.fall_2021_progress.battle_points_start,
        );
        ...
        this.actions.push(
            new SkippableAction(
                new AnimateFall2021WeeklyQuestsAction(
        ...
        if (this.data.fall_2021_progress.event_game_rewards != null) {
            ...
            this.actions.push(
                new SkippableAction(
                    new AnimateFall2021EventGameAction(section, this.data.fall_2021_progress.event_game_rewards),
                ),
            );
            this.actions.push(new SkippableAction(new WaitAction(0.5)));
        }
        ...
        if (this.data.fall_2021_progress.cavern_crawl != null) {
            ...
            this.actions.push(
                new SkippableAction(
                    new AnimateFall2021CavernCrawlAction(section, this.data.fall_2021_progress.cavern_crawl),
                ),
            );
            this.actions.push(new SkippableAction(new WaitAction(0.5)));
        }
        ...
        if (this.data.fall_2021_progress.drow_arcana_minigame != null) {
            ...
            this.actions.push(
                new SkippableAction(
                    new AnimateFall2021DrowArcanaMinigameAction(
                        section,
                        this.data.fall_2021_progress.drow_arcana_minigame,
                    ),
                ),
            );
            this.actions.push(new SkippableAction(new WaitAction(0.5)));
